<?php
namespace Contable\UI\service\finder;

use Contable\UI\utils\ContableUIUtils;

use Contable\UI\components\filter\model\UICajaCriteria;
...
class CajaFinder implements  IAutocompleteFinder {
	...
	function getEntityLabel( $entity ){
		...
		if( !empty( $entity)  ){
			...
			$params = array( $entity->getNumero(), $entity->getCajero(), ContableUIUtils::formatMontoToView($entity->getSaldo()) );
			return ContableUIUtils::formatMessage( $msg, $params);
		}
