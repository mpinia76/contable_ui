...
namespace Contable\UI\components\form\caja;

use Contable\UI\service\finder\SucursalFinder;

use Contable\UI\service\finder\EmpleadoFinder;

use Contable\UI\components\filter\model\UIEmpleadoCriteria;

use Contable\UI\components\filter\model\UISucursalCriteria;
...
//		}
	...
	public function getFechaEditable(){
		return ContableUIUtils::isAdminLogged();
	}
