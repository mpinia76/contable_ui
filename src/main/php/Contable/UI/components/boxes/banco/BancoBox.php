...
namespace Contable\UI\components\boxes\banco;
...
class BancoBox extends RastyComponent{
	...
	protected function parseXTemplate(XTemplate $xtpl){
		...
		if( !empty($banco )){
			...
			$xtpl->assign("saldo",  ContableUIUtils::formatMontoToView($banco->getSaldo()) );	
			$xtpl->assign("saldoInicial",  ContableUIUtils::formatMontoToView($banco->getSaldoInicial()) );
