...
use Contable\UI\components\grid\formats\GridEstadoGastoFormat;
...
//    	
	    ...
	    $componentConfig->setId( "gatosfilter" );
		$componentConfig->setType( "GastoFilter" );
//		
//		//TODO esto setearlo en el .rasty
	...
	protected function initModel() {
		...
		$column = GridModelBuilder::buildColumn( "fechaHora", "gasto.fechaHora", 20, EntityGrid::TEXT_ALIGN_CENTER, new GridDatetimeFormat("d/m/Y H:i:s") );
		$this->addColumn( $column );
	...
	public function getRowStyleClass($item){
		...
		//return ContableUIUtils::getEstadoGastoCss($item->getEstado());
	...
	public function getHeaderContent(){
		...
		return 'Total: '.ContableUIUtils::formatMontoToView($service->getTotales($filter->getCriteria()));
	}
