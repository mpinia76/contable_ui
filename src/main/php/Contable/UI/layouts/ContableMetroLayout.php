...
class ContableMetroLayout extends RastyLayout{
	...
	public function getContent(){
		...
		$xtpl = $this->getXTemplate( dirname(__DIR__) . "/layouts/ContableMetroLayout.htm" );
...
// 		$this->addStyle( "$webPath/metro/less/metro-bootstrap.less");
		...
		$this->addStyle( "$webPath/metro/css/contable_forms.css");
		...
		/*$this->addStyle( "$webPath/css/bootstrap/bootstrap-select.min.css");
		
		$this->addStyle( "$webPath/css/bootstrap/bootstrap.min.css");*/
	...
	protected function initScripts(){
		...
		$this->addScript("$webPath/js/contable.js");
		$this->addScript("$webPath/js/contable_utils.js");
		$this->addScript("$webPath/js/contable_forms.js");
		...
		$this->addScript("https://cdnjs.cloudflare.com/ajax/libs/bootstrap-select/1.10.0/js/bootstrap-select.min.js");*/
