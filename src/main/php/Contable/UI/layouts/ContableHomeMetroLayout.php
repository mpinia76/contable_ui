...
class ContableHomeMetroLayout extends ContableMetroLayout{
	...
	public function getContent(){
		...
		$xtpl = $this->getXTemplate( dirname(__DIR__) . "/layouts/ContableHomeMetroLayout.htm" );
	...
	public function getType(){
		...
		return "ContableHomeMetroLayout";
